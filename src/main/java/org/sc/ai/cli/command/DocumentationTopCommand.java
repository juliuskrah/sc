...
public class DocumentationTopCommand implements Runnable {
    ...
    @Option(names = {"--base-url"}, paramLabel = "BASE_URL", 
            description = {
...
class DocumentationChatCommand implements Runnable {
    ...
    @Parameters(arity = "0..1", paramLabel = "MESSAGE", 
               description = {
...
@Command(name = "config", description = {
   ...
   subcommands = {DocumentationConfigInitCommand.class})
class DocumentationConfigCommand implements Runnable {
    ...
    @Option(names = {"-g", "--get"}, paramLabel = "KEY", 
            description = {
    ...
    @Option(names = {"-s", "--set"}, paramLabel = "KEY=VALUE", 
            description = {
    ...
    @Option(names = {"-u", "--unset"}, paramLabel = "KEY", 
            description = {
...
class DocumentationRagCommand implements Runnable {
    ...
    @Option(names = {"--etl"}, paramLabel = "TARGET", 
            description = {
