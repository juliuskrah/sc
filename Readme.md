...
* The original package name 'com.simplecommerce.ai.commerce-ai' is invalid and this project uses 'com.simplecommerce.ai.commerce_ai' instead.
...
```
$ docker run --rm commerce-ai:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/commerce-ai
```
